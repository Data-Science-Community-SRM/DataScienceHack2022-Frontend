...
const About = () => {
  return (
    <div className="pb-16 mb-24 sm:mb-10 md:mb-0" id="about">
      <marquee direction="right" className="text-2xl" scrollamount="15"><span className="mr-[600px]">Hackerrank invites have been sent via mail</span>Hackerrank round would be conducted on September 1st from 6pm to 8pm</marquee>
